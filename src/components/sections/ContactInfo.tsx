...
import { EMAIL, INSTAGRAM, INSTAGRAM_HANDLE, LOCATION, PHONE, PHONE_RAW } from "@/lib/constants";
import { waLink } from "@/lib/whatsapp";

/**
 * ContactInfo — Phase 5d sidebar shown next to the Contact form.
 *
 * Stacks key contact channels (WhatsApp, email, Instagram, phone) with a
 * small Maps embed at the bottom (Fuseta sepia tint, matches About.tsx style).
 */

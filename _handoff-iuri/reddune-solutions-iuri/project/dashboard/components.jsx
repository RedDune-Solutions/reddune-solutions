...
const Icons = {
  ...
  shop:   <Icon d={<><path d="M3 9l1-5h16l1 5"/><path d="M5 9v11a1 1 0 001 1h12a1 1 0 001-1V9"/><path d="M9 13h6"/></>}/>,
};
window.Icons = Icons;
...
function Sidebar({ route, go, onClose }) {
  ...
  const items = [
    ...
    { id:'loja', label:'Loja', icon: Icons.shop, badge: (window.RDB_DATA.products || []).length || null },
  ];
  return (
    <aside className={`sidebar ${onClose ? 'open' : ''}`}>
      <div className="sb-brand" style={{justifyContent:'center', padding:'10px 8px 22px'}}>
        <img src="../assets/logo.png" alt="RedDune" style={{height:36}} />
      </div>
